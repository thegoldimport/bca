...
- [Production VibeSDK transport gate](production-vibesdk-transport-gate.md) — transport was already deployed; restore leaves ThinkAgent file hydration stale after SpaceDO forward restore.