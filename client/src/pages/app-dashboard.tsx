        ...
        {navItems.map((item) => {
          ...
          return (
            <Link key={item.path} href={item.path}>
              ...
              >
                <item.icon size={20} className={active ? "text-cyan-400" : ""} />
                {!collapsed && (
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-400 to-cyan-500 text-black font-semibold text-sm hover:from-cyan-300 hover:to-cyan-400 transition-all shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40"
