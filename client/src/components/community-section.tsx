          ...
          <div className="lg:w-1/2 relative mt-32 mb-12 lg:mt-0 lg:mb-0">
             ...
             <div className="relative aspect-square w-full max-w-[340px] md:max-w-md mx-auto">
                ...
                <motion.div 
                  ...
                  className="absolute -top-32 -right-40 md:top-0 md:right-10 p-3 md:p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl md:rounded-2xl shadow-xl z-10"
                >
                ...
                <motion.div 
                  ...
                  className="absolute -bottom-32 -left-40 md:bottom-10 md:left-0 p-3 md:p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl md:rounded-2xl shadow-xl z-20"
                >
                ...
                <motion.div 
                  ...
                  className="absolute -top-32 -left-40 md:top-10 md:left-5 p-3 md:p-5 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl md:rounded-2xl shadow-xl z-40"
                >
                ...
                <motion.div 
                  ...
                  className="absolute -bottom-32 -right-40 md:bottom-20 md:right-0 p-3 md:p-5 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl md:rounded-2xl shadow-xl z-40"
                >
                ...
                <motion.div 
                  ...
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-64 md:h-64 flex items-center justify-center z-30"
                >
